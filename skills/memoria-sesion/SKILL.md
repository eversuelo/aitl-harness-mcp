...
name: memoria-sesion
description: >-
  Cierra una sesión de trabajo grabando CADA aprendizaje en el MCP aitl-js.
  Úsala SIEMPRE al finalizar una tarea o sesión, cuando el usuario diga "guarda esto",
  "grabemos la sesión", "que no se pierda", o cuando hayas tomado una decisión
  arquitectónica, encontrado un bug no obvio, o cargado skills/roles/agents que la
  próxima sesión deba conocer. Lo que no se escribe en el MCP no existe.
---

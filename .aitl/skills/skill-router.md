...
name: skill-router
description: >-
  Meta-skill: enruta cualquier tarea a la skill, rol o agente correcto del
  proyecto aitl-js. Úsala al inicio de toda tarea no trivial. Fuente de verdad:
  colecciones skills/agents vía search_skills/get_skill; mapa completo en
  docs/MAPA-SKILLS.md.
tags:
  - meta
  - router
  - skills
  - onboarding
updated_at: 2026-07-11T23:29:47.882Z
---
